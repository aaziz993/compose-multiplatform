...
// Base32 Std
public actual fun ByteArray.encodeBase32(): ByteArray = commonEncodeBase32(BASE32)
public actual fun ByteArray.decodeBase32(): ByteArray? = commonDecodeBase32(BASE32_LOOKUP)
public actual fun ByteArray.encodeBase32ToString(): String = commonEncodeBase32(BASE32).jsDecodeToString()
public actual fun String.decodeBase32ToBytes(): ByteArray? =
    jsEncodeToByteArray().commonDecodeBase32(BASE32_LOOKUP)

// Base32 Hex
public actual fun ByteArray.encodeBase32Hex(): ByteArray = commonEncodeBase32(BASE32_HEX)
public actual fun ByteArray.decodeBase32Hex(): ByteArray? = commonDecodeBase32(BASE32_HEX_LOOKUP)
public actual fun ByteArray.encodeBase32HexToString(): String =
    commonEncodeBase32(BASE32_HEX).jsDecodeToString()

public actual fun String.decodeBase32HexToBytes(): ByteArray? =
    jsEncodeToByteArray().commonDecodeBase32(BASE32_HEX_LOOKUP)

// https://datatracker.ietf.org/doc/html/rfc4648
private val BASE32 = byteArrayOf(
...
private val BASE32_HEX = byteArrayOf(
...
private val BASE32_HEX_LOOKUP = intArrayOf(
...
private fun ByteArray.commonEncodeBase32(map: ByteArray = BASE32): ByteArray {
...
private fun ByteArray.commonDecodeBase32(lookup: IntArray = BASE32_LOOKUP): ByteArray? {
