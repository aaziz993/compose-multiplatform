 ...
 */
public object DerangementGenerator {
     ...
     */
    @JvmStatic
    public fun indices(n: Int): CombinatorialSequence<IntArray> {
     ...
     */
    @JvmStatic
    public fun <T> generate(iterable: Iterable<T>): CombinatorialSequence<List<T>> {
     ...
     */
    public inline fun <reified T> generate(array: Array<T>): CombinatorialSequence<Array<T>> {
        val n = array.size
