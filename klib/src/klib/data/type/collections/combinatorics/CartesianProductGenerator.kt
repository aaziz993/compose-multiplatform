 ...
 */
public object CartesianProductGenerator {
     ...
     */
    @JvmStatic
    public fun indices(vararg dimensions: Int, repeat: Int = 1): CombinatorialSequence<IntArray> {
     ...
     */
    @JvmStatic
    public fun <T> generate(vararg iterables: Iterable<T>, repeat: Int = 1): CombinatorialSequence<List<T>> {
        require(repeat >= 0) { "repeat must be non-negative, was $repeat" }
     ...
     * @throws IllegalArgumentException if [repeat] is negative.
     */
    public inline fun <reified T> generate(vararg arrays: Array<T>, repeat: Int = 1): CombinatorialSequence<Array<T>> {
        require(repeat >= 0) { "repeat must be non-negative, was $repeat" }
