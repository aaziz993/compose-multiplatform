...
import klib.data.type.primitives.string.fuzzywuzzy.model.EditOp
import klib.data.type.primitives.string.fuzzywuzzy.model.EditType
import klib.data.type.primitives.string.fuzzywuzzy.model.MatchingBlock
import klib.data.type.primitives.string.fuzzywuzzy.model.OpCode
...
public object DiffUtils {
    ...
    public fun getMatchingBlocks(s1: String, s2: String): Array<MatchingBlock> {

        return getMatchingBlocks(s1.length, s2.length, getEditOps(s1, s2))

    }

    public fun getMatchingBlocks(len1: Int, len2: Int, ops: Array<OpCode>): Array<MatchingBlock?> {
    ...
    public fun levEditDistance(s1: String, s2: String, xcost: Int): Int {
    ...
    public fun getRatio(s1: String, s2: String): Double {
...
public fun assert(assertion: Boolean) {
    if (!assertion)
