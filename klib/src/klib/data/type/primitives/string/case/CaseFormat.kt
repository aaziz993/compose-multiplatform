 ...
 */
public enum class CaseFormat(caseFormatterConfig: CaseFormatterConfig, wordSplitterConfig: WordSplitterConfig) : CaseFormatter by CaseFormatterConfigurable(caseFormatterConfig), WordSplitter by WordSplitterConfigurable(wordSplitterConfig) {
 ...
 */
public fun universalWordSplitter(treatDigitsAsUppercase: Boolean = true): WordSplitter =  if(treatDigitsAsUppercase) UNIVERSAL_WORD_SPLITTER_DIGITS_UPPERCASE else UNIVERSAL_WORD_SPLITTER_DIGITS_NOT_UPPERCASE
