...
public class DecimalFormatter(private val configuration: DecimalFormatterConfiguration) {
     ...
     */
    public fun format(digits: String): FormattedDecimal {
     ...
     */
    public fun format(value: BigDecimal): FormattedDecimal {
     ...
     */
    public fun format(value: Double): FormattedDecimal {
     ...
     */
    public fun format(value: Float): FormattedDecimal {
        val stringValue = getRawDigits(value.toString())
        return format(stringValue)
    }
     ...
     */
    public fun format(value: Long): FormattedDecimal {
        val stringValue = getRawDigits(value.toString())
        return format(stringValue)
    }
     ...
     */
    public fun format(value: Int): FormattedDecimal {
        val stringValue = getRawDigits(value.toString())
        return format(stringValue)
    }
