...
internal interface BaseExtension {
    ...
    fun applyTo() {
        ...
        (compileSdkVersion ?: project.settings.libs.versions["project.android.compileSdk"]?.toInt())
...
private object BaseExtensionSerializer : ReflectionMapTransformingPolymorphicSerializer<BaseExtension>(
    BaseExtension::class,
)
