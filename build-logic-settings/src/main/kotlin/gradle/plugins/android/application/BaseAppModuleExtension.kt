...
internal data class BaseAppModuleExtension(
    ...
    override val buildTypes: Set<@Serializable(with = ApplicationBuildTypeKeyTransformingSerializer::class) ApplicationBuildType>? = null,
    override val defaultConfig: DefaultConfig? = null,
    override val productFlavors: Set<@Serializable(with = ProductFlavorKeyTransformingSerializer::class) ProductFlavor>? = null,
    override val signingConfigs: Set<@Serializable(with = SigningConfigKeyTransformingSerializer::class) SigningConfigImpl>? = null,
