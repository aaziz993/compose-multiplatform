 ...
 *
 * Product flavors support the same properties as the [gradle.plugins.android.defaultconfig.DefaultConfigDsl] block—this is because
 * `defaultConfig` defines a [ProductFlavorDsl] object that the plugin uses as the base configuration
 ...
 * *[each flavor must belong to a `dimension`][com.android.build.api.dsl.ProductFlavor.dimension]*.
 *
 * When you configure product flavors, the Android plugin automatically combines them with your
 * [gradle.plugins.android.BuildType] configurations to
