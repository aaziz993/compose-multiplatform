...
/**
 * Shared properties between DSL objects [ProductFlavorDsl] and [gradle.plugins.android.defaultconfig.DefaultConfigDsl]
 */
internal interface BaseFlavor<T : BaseFlavor> : VariantDimension<T> {
    ...
    override fun applyTo(receiver: T) {
        ...
        receiver::minSdk trySet (project.settings.libs.versions["android.minSdk"]?.toInt())
