...
@Serializable
internal data class LibraryProductFlavorImpl(
...
) : gradle.plugins.android.library.LibraryProductFlavor<LibraryProductFlavor>

internal object LibraryProductFlavorTransformingSerializer : KeyTransformingSerializer<LibraryProductFlavorImpl>(
    LibraryProductFlavorImpl.serializer(),
    "name",
)
