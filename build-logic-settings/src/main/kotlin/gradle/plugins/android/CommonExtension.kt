...
internal interface CommonExtension<
     ...
     * generated bytecode.
     *
     * For more information about the properties you can configure in this block, see [gradle.plugins.android.compile.CompileOptions].
     */
     ...
     *
     * Unlike using [gradle.plugins.android.flavor.ProductFlavorDsl] to create
     ...
     *
     * For more information about the properties you can configure in this block, see [gradle.plugins.android.features.DataBinding]
     */
     ...
     *
     * For more information about the properties you can configure in this block, see [gradle.plugins.android.features.ViewBinding]
     */
     ...
     * ```
     *
     * For more information about the properties you can configure in this block, see [gradle.plugins.android.test.TestCoverage].
     */
     ...
     */
    val compileSdkAddon: CompileSdkAddon?
    ...
    fun applyTo() {
        ...
        (buildToolsVersion
            ?: project.settings.libs.version("extension.buildToolsVersion"))?.let { buildToolsVersion ->
