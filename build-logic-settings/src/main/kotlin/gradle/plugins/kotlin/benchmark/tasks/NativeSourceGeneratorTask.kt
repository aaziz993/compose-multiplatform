...
internal abstract class NativeSourceGeneratorTask<T : kotlinx.benchmark.gradle.NativeSourceGeneratorTask> :
    DefaultTask<T>() {
    ...
    abstract val nativeTarget: String
    ...
    override fun applyTo(receiver: T) {
        ...
        receiver::nativeTarget trySet nativeTarget
...
@Serializable
@SerialName("NativeSourceGeneratorTask")
internal data class NativeSourceGeneratorTaskImpl(
    ...
    override val nativeTarget: String, override val outputResourcesDir: String? = null,
...
) : NativeSourceGeneratorTask<kotlinx.benchmark.gradle.NativeSourceGeneratorTask>() {

    context(Project)
    override fun applyTo() =
        applyTo(project.tasks.withType<kotlinx.benchmark.gradle.NativeSourceGeneratorTask>())
}
