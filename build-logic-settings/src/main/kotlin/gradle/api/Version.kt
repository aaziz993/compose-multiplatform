...
internal fun Project.version(): String {
    ...
    return Version(
        project.settings.libs.versions.version("$camelCaseName.version.major")?.toInt()
            ?: projectProperties.version.major,
        project.settings.libs.versions.version("$camelCaseName.version.minor")?.toInt()
            ?: projectProperties.version.minor,
        project.settings.libs.versions.version("$camelCaseName.version.patch")?.toInt()
            ?: projectProperties.version.patch,
        project.settings.libs.versions.version("$camelCaseName.version.preRelease")
            ?: projectProperties.version.preRelease,
        project.settings.libs.versions.version("$camelCaseName.version.buildMeta") ?: "${
