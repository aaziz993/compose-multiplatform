 ...
 */
internal fun Settings.setupClasspath(
    vararg dependencies: String,
    adjustDependencies: RepositoryHandler.() -> Unit,
) {
    val internalGradle = gradle as GradleInternal
    internalGradle.doSetupClasspath(this as SettingsInternal, adjustDependencies, *dependencies)
}

private fun GradleInternal.doSetupClasspath(
