...
private fun testStarted(testName: String) {
    println("##$CI[testStarted name='%s']".format(escape(testName)))
}

private fun testFinished(testName: String) {
    println("##$CI[testFinished name='%s']".format(escape(testName)))
}

private fun testFailed(name: String, message: String, details: String) {
    println("##$CI[testFailed name='%s' message='%s' details='%s']".format(escape(name), escape(message), escape(details)))
}
