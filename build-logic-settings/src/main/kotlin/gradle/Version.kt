...
public fun Project.version(major: Int, minor: Int, patch: Int, parsedPreRelease: String? = null): String =
    Version(
        major, minor, patch, parsedPreRelease,
        "${gitRef.orEmpty()}${gitRunNumber.orEmpty()}${spaceGitBranch.orEmpty()}${spaceExecutionNumber.orEmpty()}",
    ).toString()
