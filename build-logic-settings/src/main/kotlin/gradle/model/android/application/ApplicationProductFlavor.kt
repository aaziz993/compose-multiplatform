 ...
 */
@Serializable
internal data class ApplicationProductFlavor(
    ...
    override fun applyTo(dimension: VariantDimension) {
        ...
        dimension as com.android.build.api.dsl.ApplicationProductFlavor

        dimension::isDefault trySet isDefault
    }
}

internal object ApplicationProductFlavorTransformingSerializer : KeyTransformingSerializer<ApplicationProductFlavor>(
    ApplicationProductFlavor.serializer(),
    "name",
)
