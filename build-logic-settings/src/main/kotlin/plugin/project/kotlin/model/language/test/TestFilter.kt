...
internal interface TestFilter {
    ...
    /**
     * Returns the included test name patterns. They can be class or method names and may contain wildcard '*'. Test name patterns can be appended via [.includeTestsMatching] or set via
     * [.setIncludePatterns].
     *
