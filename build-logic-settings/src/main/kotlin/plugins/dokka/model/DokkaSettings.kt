...
internal data class DokkaSettings(
    ...
    override val dokkaPublications: LinkedHashSet<@Serializable(with = DokkaPublicationTransformingSerializer::class) DokkaPublication>? = null,
    override val dokkaSourceSets: LinkedHashSet<@Serializable(with = DokkaSourceSetSpecTransformingSerializer::class) DokkaSourceSetSpec>? = null,
    override val pluginsConfiguration: LinkedHashSet<@Serializable(with = DokkaPluginParametersBaseSpecTransformingSerializer::class) DokkaPluginParametersBaseSpec<*>>? = null,
