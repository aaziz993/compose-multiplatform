...
public val ThumbColor: Color = Color(0xfff0f0f0)
public val ActiveTrackColor: Color = Color(0xff489cef)
public val InactiveTrackColor: Color = Color(0xffcccccc)

/**
 * Data class that contains color or/and brush property for drawing track section of
 * [ColorfulSlider]
 */
public data class SliderBrushColor(
     ...
     */
    val solidColor: SolidColor = SolidColor(color)
}
 ...
 */
public object MaterialSliderDefaults {
    ...
    private fun disabledActiveTrackSolidColor() =
        MaterialTheme.colorScheme.onSurface.copy(alpha = DISABLED_ACTIVE_TRACK_ALPHA)
    ...
    private fun inactiveTrackSolidColor(color: SliderBrushColor) =
        color.color.copy(alpha = INACTIVE_TRACK_ALPHA)
    ...
    private fun activeTickSolidColor(color: SliderBrushColor) =
        contentColorFor(color.color).copy(alpha = TICK_ALPHA)

    @Composable
    private fun inActiveTickSolidColor(color: SliderBrushColor) =
        color.color.copy(alpha = TICK_ALPHA)

    @Composable
    private fun disabledActiveTickSolidColor(color: SliderBrushColor) =
        color.color.copy(alpha = DISABLED_TICK_ALPHA)
    ...
    public fun materialColors(
        ...
        disabledInactiveTrackColor: SliderBrushColor = SliderBrushColor(
            color = disabledActiveTrackColor.color.copy(alpha = DISABLED_INACTIVE_TRACK_ALPHA)
    ...
    public class DefaultMaterialSliderColors(
     ...
     */
    private const val TICK_ALPHA = 0.54f

    /**
     * Default alpha for tick marks when they are disabled
     */
    private const val DISABLED_TICK_ALPHA = 0.12f
...
public interface MaterialSliderColors {
     ...
     */
    @Composable
    public fun thumbColor(enabled: Boolean): State<Brush>
     ...
     */
    @Composable
    public fun trackColor(enabled: Boolean, active: Boolean): State<Brush>
     ...
     */
    @Composable
    public fun tickColor(enabled: Boolean, active: Boolean): State<Brush>
