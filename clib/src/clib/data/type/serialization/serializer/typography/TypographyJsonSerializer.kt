package clib.data.type.serialization.serializer.typography
...
public object TypographyJsonSerializer : StringSerializer<Typography>(Typography::class.simpleName!!, { "" }, { Typography() }) {
